...
|--------------------------------------|-----------------------------------|
| ![PCA Comparison](plots/gen_smp_pc1_vs_pc2.jpg) | ![Sampled PCA Labels](plots/gen_2-Components_PCA_Projection_of_sampled_sequences.jpg) |
...
|------------------------------------|----------------------------|
| ![t-SNE Clusters](plots/gen_t-SNE_2_components_with_cluster_labels.jpg) | ![Sampled Elbow](plots/gen_smp_clustering_kmedoids_score_elbow.png) |
